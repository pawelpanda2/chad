/**
 * Durable outbox for Google Sheets sync jobs (Story 75).
 *
 * Mirrors `data-outbox.ts`'s proven shape (status enum, attempts/
 ...
 * this is a parallel module rather than a reuse of `data-outbox.ts`'s types.
 *
