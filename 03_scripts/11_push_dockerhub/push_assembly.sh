...
# ============================================
# Push obrazu cp_blazor na Docker Hub
# ============================================
# Użycie:
#   ./push_assembly.sh                    # auto: wybiera najnowszy tag datowy
#   ./push_assembly.sh 260615_194030      # push konkretnego lokalnego taga
#   ./push_assembly.sh latest             # push z tagiem latest
# ============================================
