#!/usr/bin/env bash
# Stops the QNAP PROD dashboard ONLY. Never touches the shared mongo/
# content-provider-api stack, test, or local-mac. --remove-orphans only,
...
log_ok "chad-prod dashboard stopped. Data volume and images preserved. Shared services (mongo/content-provider-api) untouched."
